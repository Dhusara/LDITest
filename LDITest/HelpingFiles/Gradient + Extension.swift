...
public enum CAGradientPoint {
    ...
    var point: CGPoint {
        ...
        case .bottomLeft: return CGPoint(x: 0, y: 1.0)
...
extension CAGradientLayer {
    ...
    convenience init(start: CAGradientPoint, end: CAGradientPoint,
                     colors: [CGColor], type: CAGradientLayerType) {
        self.init()
...
extension UIView {
    ...
    func layerGradient(startPoint: CAGradientPoint, endPoint: CAGradientPoint,
                       colorArray: [CGColor], type: CAGradientLayerType ) {
        let gradient = CAGradientLayer(start: .topLeft, end: .topRight,
                                       colors: colorArray, type: type)
